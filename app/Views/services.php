<?= $this->include('templates/header_pages'); ?>
    ...
    <div class="wrapper image-wrapper bg-image page-title-wrapper inverse-text" data-image-src="style/images/art/bg11.jpg">
      <div class="container inner text-center">
        ...
        <p class="lead">Creating quality products that make your life easier</p>
      </div>
      <!-- /.container -->
    ...
    <div class="wrapper gray-wrapper">
      <div class="container inner">
        <h2 class="display-2 text-center">Find out everything you need to know <br class="d-none d-lg-block" />about creating a business process model.</h2>
    ...
    <div class="wrapper light-wrapper">
      <div class="container inner">
        <h2 class="display-2 text-center">We offer great prices, premium products <br class="d-none d-lg-block" />and quality service for your business.</h2>
        <div class="space40"></div>
        <div class="pricing-wrapper">
          ...
          <div class="row no-gutters">
            <div class="col-md-4">
              <div class="pricing panel box bg-white shadow">
                <div class="panel-heading">
                  <div class="icon icon-svg mb-10"><img src="style/images/icons/ec-mobile.png" alt=""></div>
            ...
            <div class="col-md-4 popular">
              <div class="pricing panel box bg-white shadow">
                <div class="panel-heading">
                  <div class="icon icon-svg mb-10"><img src="style/images/icons/ec-online-shop.png" alt=""></div>
            ...
            <div class="col-md-4">
              <div class="pricing panel box bg-white shadow">
                <div class="panel-heading">
                  <div class="icon icon-svg mb-10"><img src="style/images/icons/ec-store.png" alt=""></div>
