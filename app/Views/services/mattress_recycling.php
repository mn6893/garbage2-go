...
<div class="service-hero">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6">
                <h1>Mattress Recycling Melbourne</h1>
                <p class="lead">Eco-friendly mattress disposal and recycling services</p>
                <div class="mt-4">
            ...
            <div class="col-lg-6">
                <img src="<?= base_url('style/images/services/mattress-recycling.jpg') ?>" alt="Mattress Recycling" class="img-fluid service-image">
            </div>
        </div>
    </div>
</div>
<div class="wrapper py-5">
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                <h2>Professional Mattress Recycling Services</h2>
                <p class="lead">Dispose of your old mattresses responsibly. We ensure proper recycling to minimize environmental impact.</p>
                <div class="service-features mb-5">
                    <h3>What We Recycle:</h3>
                    <ul><li>All sizes of mattresses</li><li>Box springs</li><li>Memory foam mattresses</li><li>Sofa beds</li><li>Futon mattresses</li></ul>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="contact-section">
                    <h3>Get Your Free Quote</h3>
                    <p>Need mattress removal?</p>
